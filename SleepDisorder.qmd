...
data_GBM<-data
data_GBM$Gender <- as.factor(data$Gender)
data_GBM$Occupation <- as.factor(data$Occupation)
data_GBM$BMI.Category <- as.factor(data$BMI.Category)
data_GBM$Sleep.Disorder <- as.factor(data$Sleep.Disorder)
data_GBM$Blood.Pressure.Category <- as.factor(data$Blood.Pressure.Category)
